...
// profile. ID and basic profile are included in DEFAULT_SIGN_IN.
        ...
        findViewById(R.id.skip_sign_in_button).setOnClickListener(new View.OnClickListener() {
            @Override
...
// the GoogleSignInAccount will be non-null.
    ...
    private void updateUI(GoogleSignInAccount signInAccount) {
        Toast.makeText(this, "got the object as---"+signInAccount, Toast.LENGTH_SHORT).show();
    }
}
